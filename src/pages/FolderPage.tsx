...
const FolderPage = ({ onNavigate }: FolderPageProps) => {
  ...
  return (
    <div className="flex-1 h-full bg-background overflow-hidden flex">
      {/* Folders List */}
      {showFolderList && (
        <div className={`${isMobile ? "w-full" : "w-80"} h-full bg-card border-r border-border flex flex-col`}>
          ...
          {selectedFolder ? (
            <>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h1 className="text-xl md:text-2xl font-bold text-foreground">{selectedFolder.name}</h1>
        ...
        {showCreateModal && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[calc(100%-2rem)] max-w-sm bg-card rounded-2xl shadow-xl z-50 p-6"
            >
